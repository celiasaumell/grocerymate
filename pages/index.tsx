...
export default function Home() {
  ...
  return (
    <div className={isOpen ? "h-screen overflow-hidden" : "overflow-hidden"}>
      <Head>
      ...
      <header className="z-50 flex w-full min-w-[290px] p-5">
        <h1
          className={`${styles.title}  w-full text-5xl font-bold tracking-tight sm:text-6xl`}
        >
        ...
        <nav
          ...
          data-visible={isOpen}
          className="absolute top-0 right-0 bottom-0 left-1/2 z-0 flex min-h-full min-w-[190px] flex-col space-y-8 bg-white px-5 py-20 text-center "
        >
